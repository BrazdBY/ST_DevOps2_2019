...
Set-Item WSMan:\localhost\Client\TrustedHosts -Value vm1-pogulaev
Set-Item WSMan:\localhost\Client\TrustedHosts -Value vm2-pogulaev
Set-Item WSMan:\localhost\Client\TrustedHosts -Value vm3-pogulaev
